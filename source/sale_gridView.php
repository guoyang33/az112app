		...
		<div style="width: 70% ; height: 100px ; float: right">
			<?php
				...
				echo	"<table style='margin: 20px auto ; background-color: #BDBDBD ; border-spacing: 1px'>".
						...
						"		<th colspan='7' style='padding: 5px'>Salse Order Quick View</th></tr>".
						"	<tr style='background-color: #FFFFFF'>".
						"		<th style='padding: 5px'>Salse No</th>".
						"		<th style='padding: 5px'>Salse date</th>".
						"		<th style='padding: 5px'>Customer ID</th>".
						"		<th style='padding: 5px'>Salse Amount</th>".
